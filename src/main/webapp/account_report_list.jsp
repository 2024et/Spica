...
<section>
	<h1>会計報告書</h1>
	<button onclick="location.href='purchase_request_formServlet'" class="new-request-btn">会計報告書の作成</button>
	<table>
		<thead><th>会計報告書</th></thead>
		<tbody>
			<c:forEach var="c" items="${account_report}">
				<tr>
					<td>
